...
# Set wide layout and page name - always on top
st.set_page_config(layout="wide", page_title="Personal Carbon Calculator")

# Streamlit app code-- streamlit run name.py
st.title("FIT COM CARBON CALCULATOR ⚠️")

# user input
st.subheader("🌍 Your Country")
country = st.selectbox("Select", ["India"])

# divides page of app in 2 columns
...
# Calculate carbon emissions fromm formulas
...
total_emissions = round(
    ...
    diet_emissions + waste_emissions, 2
)
...
if st.button("Calculate CO2 Emissions"):
    ...
    with col3:
        ...
        st.info(
            f"🚗 Transportation: {transportation_emissions} tonnes CO2 per year")
    ...
    with col4:
        ...
        st.success(
            f"🌍 Your total carbon footprint is: {total_emissions} tonnes CO2 per year")
